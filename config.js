module.exports = {
	...
	adminId: process.env.adminId || "UserId", //- Replace UserId with the Discord ID of the admin of the bot
	...
	supportServer: "https://discord.com/invite/C73RyU9h", //- Support Server Link
	...
	nodes: [
		{
			...
			host: "unfair-dix-aras-5ef48fc3.koyeb.app", //- The host name or IP of the lavalink server.
